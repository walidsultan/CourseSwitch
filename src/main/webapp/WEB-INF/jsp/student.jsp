...
<script type="text/javascript"
	src="/CourseSwitch/resource/js/StudentAdd.js"></script>
...
<!--  
      	<div class="form-group">
			<label class="control-label col-lg-2" for="roles">Semester Block Courses: </label>
			<div class="col-lg-10">
				<form:checkboxes items="${registeredCourse}" path="roles" />
			</div>
		</div>
-->		
